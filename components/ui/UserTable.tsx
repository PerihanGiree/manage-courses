...
const UserTable: React.FC<PropsType> = ({
  ...
  return (
    <div>
      <table className="w-full flex flex-col mb-6 ">
        ...
        <tbody className="w-full h-[70vh] overflow-auto">
          {users.map((user) => (
            ...
            >
              ...
              <td
                className={`${headerTitles[6].className} flex flex-row justify-end items-center pr-4`}
              >
                <button
                ...
                <button onClick={() => handleEditClick(user)} className="mr-8">
                  <img src={Edit} alt="" />
                </button>
                <button
                  onClick={() => {
